...
export const meta = {
  ...
  id: "como-montar-um-blog-com-nextjs-e-mdx-100-estatico-com-deploy-no-netlify",
};
...
Para este ejemplo, vamos a crear una aplicación desde cero utilizando Vite y React. Si ya tienes una aplicación creada, puedes saltarte este paso, pero asegurate de tener configurado `primary`, ya que vamos a utilizarlo para automatizar parte del proceso.
...
export default ({ children }) => (
  <BlogLayoutPage meta={meta}>{children}</BlogLayoutPage>
);
